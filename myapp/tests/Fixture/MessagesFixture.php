...
class MessagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'category_id' => ['type' => 'smallinteger', 'length' => 6, 'unsigned' => false, 'null' => true, 'default' => '0', 'comment' => '', 'precision' => null],
        ...
        'create_datetime' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => 'CURRENT_TIMESTAMP', 'comment' => '', 'precision' => null],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'create_datetime' => '2021-02-19 07:31:22',
            ],
        ];
        parent::init();
    }
